...
const getSocialProof = (index) => {
  return NEW_ARRIVAL_SOCIAL_PROOF_LABELS[index % NEW_ARRIVAL_SOCIAL_PROOF_LABELS.length];
};
    ...
    <section className="section-shell py-5 sm:py-7 lg:py-10">
      <div className="mx-auto px-4 md:px-10">
        ...
        <div className="flex flex-col items-center gap-2 text-center md:gap-3">
          <h1 className="text-4xl font-bold capitalize leading-snug lg:text-5xl">
