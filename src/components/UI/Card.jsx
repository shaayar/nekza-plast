...
export default function Card({ product, slug, badges = [] }) {
    ...
    return (
        <div className="group relative flex h-full w-[50vw] max-w-95 shrink-0 flex-col gap-2 overflow-hidden rounded-xl border border-gray-300 px-2 pb-2 transition-colors duration-300 hover:border-primary/30 md:w-[50vw] md:gap-3 lg:w-[25vw]">
            ...
            <div className="pointer-events-none absolute -bottom-10 -right-10 h-30 w-30 rounded-full bg-primary/10 opacity-0 blur-xl transition-all duration-300 group-hover:opacity-100 group-hover:bg-primary/20" />
            ...
            {/* ── Title ── */}
            <Link to={productPath} className="relative z-10 flex items-center justify-start rounded transition-all duration-200">
